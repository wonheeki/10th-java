...
//        System.out.println(temp[0]); // NullPointerException
        ...
        System.out.println("intArray: "+intArray); // [I@6d03e736 참조 주소가 저장되어 있음
        intArray[1]=77;
        System.out.println("intArray[1]: "+intArray[1]); //
...
//        charArray = {"a","b","c"}; // 컴파일 에러
        ...
        System.out.println("deep arrays deepEquals (1 vs 2) : "+deepArraysEqual1); // true
        System.out.println("deep arrays deepEquals (1 vs 3) : "+deepArraysEqual2); // false

        // binarySearch(arr,val) 메서드 (단, 배열이 정렬된 상태여야 함)
