...
public class ConditionalStatement {
    public static void main(String[] args) {
        ...
        // 동일한 문자열 리터럴이 사용되는 경우, Java 컴파일이라는 문자열 풀(string pool)이라는 공유된 메모리 영역에 해당 문자열을 저장
        // str1, str2 같은 문자열을 가리키고 있으므로 같은 참조값을 가짐
        String str1 = "hello";
        String str2 = "hello";
        ...
        //////////////////////////////
        // switch -case문
        // - 각 case문의 break문으로 선택사항, break문 생략시 바로 밑의 case문으로 넘어감
        String dayOfWeek ;
        int day = 4;
